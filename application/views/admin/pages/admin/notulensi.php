    <div class="content-page">
    	<div class="content">
    		...
    		<div class="container-fluid">
    			...
    			<div class="row">
    				<div class="col-lg-12">
    					<a href="" class="btn btn-primary mb-3 newNotulensiModalButton" data-toggle="modal" data-target="#newNotulensiModal">Tambah Notulensi Baru</a>
    					<div class="mb-2">
                            <div class="row">
    						...
    						<tbody>
    							...
    							<?php foreach ($notulensi as $key) : ?>
    								<tr>
    									...
    									<td><img src="<?= base_url('uploads/notulensi/') . $key['thumbnail'] ?>" class="img-thumbnail" style="width: 300px;"></td>
    									<td>
    										<a href="<?= base_url("admin/Pengurus/updateNotulensi/$key[id]"); ?>" class="badge badge-success updateNotulensiModalButton" data-toggle="modal" data-target="#newNotulensiModal" data-id="<?= $key['id'] ?>">Ubah</a>
    										<a href="<?= base_url("admin/Pengurus/deleteNotulensi/$key[id]"); ?>" class="badge badge-danger" onclick="return confirm('Are you sure?');">Hapus</a>
    									</td>
    								</tr>
    								<?php $no++; ?>
    							<?php endforeach ?>
    ...
    <!-- Modal -->
    <div class="modal fade" id="newNotulensiModal" tabindex="-1" aria-labelledby="newNotulensiModalLabel" aria-hidden="true">
    	<div class="modal-dialog">
    		<div class="modal-content">
    			<div class="modal-header">
    				<h5 class="modal-title" id="newNotulensiModalLabel">Tambah Notulensi</h5>
    				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
    					<span aria-hidden="true">&times;</span>
    				</button>
    			</div>
    			<form action="<?= base_url('admin/Pengurus/notulensi') ?>" method="post" enctype="multipart/form-data">
