    <div class="content-page">
    	<div class="content">
    		...
    		<div class="container-fluid">
    			...
    			<div class="row">
    				<div class="col-lg-12">
    					<a href="" class="btn btn-primary mb-3 newBeritaModalButton" data-toggle="modal" data-target="#newBeritaModal">Tambah Berita Baru</a>
                        <div class="mb-2">
                            <div class="row">
    						...
    						<tbody>
    							...
    							<?php foreach ($berita as $key) : ?>
    								<tr>
    									...
    									<td><img src="<?= base_url('uploads/berita/') . $key['thumbnail'] ?>" class="img-thumbnail" style="width: 300px;"></td>
    									<td>
    										<a href="<?= base_url("admin/Pengurus/updateBerita/$key[id]"); ?>" class="badge badge-success updateBeritaModalButton" data-toggle="modal" data-target="#newBeritaModal" data-id="<?= $key['id'] ?>">Ubah</a>
    										<a href="<?= base_url("admin/Pengurus/deleteBerita/$key[id]"); ?>" class="badge badge-danger" onclick="return confirm('Are you sure?');">Hapus</a>
    									</td>
    								</tr>
    								<?php $no++; ?>
    							<?php endforeach ?>
    ...
    <!-- Modal -->
    <div class="modal fade" id="newBeritaModal" tabindex="-1" aria-labelledby="newBeritaModalLabel" aria-hidden="true">
    	<div class="modal-dialog">
    		<div class="modal-content">
    			<div class="modal-header">
    				<h5 class="modal-title" id="newBeritaModalLabel">Tambah Berita</h5>
    				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
    					<span aria-hidden="true">&times;</span>
    				</button>
    			</div>
    			<form action="<?= base_url('admin/Pengurus/berita') ?>" method="post" enctype="multipart/form-data">
