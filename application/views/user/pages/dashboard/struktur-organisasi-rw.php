    ...
    <div class="row">
      <div class="col-lg-12 text-center">
          <ul class="list-inline mb-0">
           ...
           <h1 class="text-lg text-white mt-2">Struktur Organisasi <br> Petugas RW</h1>
      </div>
    </div>
  </div>
</section>
...
<!-- <h1 style="text-align:center" class="text-black mt-1">Petugas RW</h1> -->
  <div class="card mt-3 mb-3">
      ...
      <!-- <?=$this->uri->segment(4);?> -->
				<div id="struktur_organisasi_rw-chart" style="height: 570px;"></div>
			</div>
		</div>
	</div>
</div> -->
